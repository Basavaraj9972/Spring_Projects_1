...
<script src="DeleteBlogValidation.js"></script>
...
<body>
	  <form onsubmit="return validateForm()" action="DeleteBlogSevlet" method="post" >
        <div>
...
<% String error_msg = (String)session.getAttribute("Problem_occur_try_Again");
	if(error_msg != null && error_msg.equals("Problem_occur_try_Again")){ %>
		<script> alert("Invalid blogId enter correct blogId try Again")</script>
		<% error_msg = null; %>
