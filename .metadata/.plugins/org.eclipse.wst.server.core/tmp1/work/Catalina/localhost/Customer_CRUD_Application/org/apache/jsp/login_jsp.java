 ...
 * Generated at: 2025-01-30 18:38:26 UTC
...
public final class login_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("    </form>\r\n");
      out.write("    <script>\r\n");
      out.write("        document.getElementById('loginForm').addEventListener('submit', async (e) => {\r\n");
      ...
      out.write("\r\n");
      out.write("            const response = await fetch('/api/authenticate', {\r\n");
      out.write("                method: 'POST',\r\n");
      out.write("                headers: { 'Content-Type': 'application/json' },\r\n");
      out.write("                body: JSON.stringify({ username, password })\r\n");
      out.write("            });\r\n");
      out.write("\r\n");
      out.write("            if (response.ok) {\r\n");
      out.write("                const result = await response.json();\r\n");
      out.write("                localStorage.setItem('token', result.token); // Store token in local storage\r\n");
      out.write("                window.location.href = 'customerList.jsp';\r\n");
      out.write("            } else {\r\n");
